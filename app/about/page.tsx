        ...
        >
          ...
          >
            ...
            <div style={{ flex: 1, minWidth: 260 }}>
              <h3 style={{ fontSize: 26, margin: 0, color: "#2E2419" }}>
              ...
              >
                Our Smart Doorbell Camera brings high-definition video, two-way
                audio, and motion detection to your doorstep. Easy to install
                and integrated with your existing CCTV setup — perfect for homes
                and small businesses.
              </p>
              <ul style={{ marginTop: 12, color: "#2E2419" }}>
                <li>1080p / 2K HD video</li>
                <li>Night vision & motion alerts</li>
                <li>Weather-resistant casing</li>
                <li>Two-way audio + remote access</li>
              </ul>
